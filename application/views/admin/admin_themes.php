...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url('assets/image/logo/bh.png'); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">APD</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('Apd'); ?>" class="nav-link <?php echo $subtitle=="Apd"?"active":""; ?>">
          ...
          <?php
            if($subtitle == 'Pengaturan' || $subtitle == 'Petugas') {
              echo "menu-open";
            }
          ?>
          ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Petugas'); ?>" class="nav-link <?php echo $subtitle=="Petugas"?"active":""; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Petugas Lapangan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pengaturan'); ?>" class="nav-link <?php echo $subtitle=="Pengaturan"?"active":""; ?>">
