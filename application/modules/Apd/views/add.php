          ...
          <form role="form" method="POST" action="<?php echo site_url($url.'/insert'); ?>">
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="nama_apd" class="form-control" placeholder="Jenis APD" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div id="image" onclick="openKCFinder(this)"><div style="margin:80px;"><input type="hidden" name="foto" value="">Click here to choose an image</div></div>
              </div>
              <div class="form-group">
